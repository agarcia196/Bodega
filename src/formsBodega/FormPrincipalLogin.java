...
public class FormPrincipalLogin extends JFrame implements Serializable, ActionListener {
	...
	public FormPrincipalLogin() {
		...
		JLabel lblInformacionDelUser = new JLabel("Datos de Gerente");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (validar == 0) {
					if (txtNombre.getText().compareTo("")==0 || txtNombreU.getText().compareTo("")==0 ||
						...
						Empresa empresa = new Empresa(txtNombre.getText(),"Imagenes\\"+txtNombre.getText()+".jpg");
						...
						empresa.AddUser(p);	
						System.out.println(empresa.getUsuarios()[0].getNombre());
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (result != JFileChooser.CANCEL_OPTION) {
			...
			if ((fileName == null) || (fileName.getName().equals(""))) {
				...
				ImageIcon iconlogo =new ImageIcon(RutaImagen);
				Icon iconologo = new ImageIcon(iconlogo.getImage().getScaledInstance(lblImagen.getWidth(),lblImagen.getHeight(), Image.SCALE_DEFAULT));
				lblImagen.setIcon(iconologo);          
				contentPane.add(lblImagen);
			}
		} 
	}
